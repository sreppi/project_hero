...
// Main Menu Variables
boolean clickOnGameStartButton = false;
boolean hoverOnGameStartButton = false;
...
void draw() {
  ...
  case MAINMENU:
    ...
    mouseOnGameStartButton();
    if (hoverOnGameStartButton == true) {
      startButtonRColor = 193;
      startButtonGColor = 150;
      startButtonBColor = 49;
    } else {
      startButtonRColor = 232;
      startButtonGColor = 189;
      startButtonBColor = 80;
    }
